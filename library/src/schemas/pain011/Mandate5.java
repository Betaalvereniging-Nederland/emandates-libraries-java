 ...
 *       &lt;sequence>
 *         &lt;element name="MndtId" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}Max35Text"/>
 *         &lt;element name="MndtReqId" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}Max35Text" minOccurs="0"/>
 *         &lt;element name="Tp" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}MandateTypeInformation1" minOccurs="0"/>
 *         &lt;element name="Ocrncs" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}MandateOccurrences3" minOccurs="0"/>
 *         &lt;element name="ColltnAmt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="MaxAmt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}ActiveOrHistoricCurrencyAndAmount" minOccurs="0"/>
 *         &lt;element name="Rsn" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}MandateSetupReason1Choice" minOccurs="0"/>
 *         &lt;element name="CdtrSchmeId" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}PartyIdentification43" minOccurs="0"/>
 *         &lt;element name="Cdtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}PartyIdentification43"/>
 *         &lt;element name="CdtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}CashAccount24" minOccurs="0"/>
 *         &lt;element name="CdtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}BranchAndFinancialInstitutionIdentification5" minOccurs="0"/>
 *         &lt;element name="UltmtCdtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}PartyIdentification43" minOccurs="0"/>
 *         &lt;element name="Dbtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}PartyIdentification43"/>
 *         &lt;element name="DbtrAcct" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}CashAccount24"/>
 *         &lt;element name="DbtrAgt" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}BranchAndFinancialInstitutionIdentification5"/>
 *         &lt;element name="UltmtDbtr" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}PartyIdentification43" minOccurs="0"/>
 *         &lt;element name="RfrdDoc" type="{urn:iso:std:iso:20022:tech:xsd:pain.011.001.04}ReferredDocumentInformation6" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
