...
<form action="<c:url value="/Products/NewMandateResult" />" class="form-horizontal" method="post" role="form">
...
<option selected="selected">RCUR</option>
        ...
        <hr />
        <div class="form-group">
            <button type="submit" class="btn btn-primary">New eMandate</button>
        </div>
</form>    </div>
