...
<div>
    ...
    <form action="<c:url value="/Products/AmendMandateResult" />" class="form-horizontal" method="post" role="form">        <div class="form-group">
...
<option selected="selected">RCUR</option>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-3">
                <label for="OriginalDebtorBankId">OriginalDebtorBankId</label>
                <input class="form-control" id="OriginalDebtorBankId" name="OriginalDebtorBankId" type="text" value="">
            </div>
        </div>
        <hr>
        <div class="form-group">
            <button type="submit" class="btn btn-primary">Send amendment request</button>
        </div>
</form>
</div>
